...
CREATE TABLE `historial_compras` (
  ...
  `identificacion_id` varchar(20) DEFAULT NULL,
  `fecha` datetime DEFAULT NULL,
  `total` decimal(10,2) DEFAULT NULL,
  `productos` text,
  PRIMARY KEY (`id`),
  KEY `identificacion_id` (`identificacion_id`),
  CONSTRAINT `historial_compras_ibfk_1` FOREIGN KEY (`identificacion_id`) REFERENCES `usuario` (`identificacion`)
...
INSERT INTO `historial_compras` VALUES (1,'40219113','2025-05-03 18:57:46',80000.00,'[\"bolso\"]');
